...
• 20% 🌱 【基金轮动策略】         (场外 C 类公募动量滚雪球，周四 14:48 黄金免申赎费窗口)
...
> ⏰ **监控时间**：{now_str} (北京时间)
> 🏛️ **大舰队统合架构**：稳健财富型 (50% 纳指银行DTB + 20% 基金轮动 + 15% 五福ETF + 15% 七星轮动)
...
• **20% 基金轮动策略**: 锁定 006503 财通集成电路等高景气赛道，每晚 21:00 净值复盘，周四 14:48 黄金调仓；

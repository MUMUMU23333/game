...
"""
====================================================================================================
🏛️【全球宏观大势与量化全景战略研报 · 策略实盘持仓精准校对版】
====================================================================================================
系统架构：
  1. 【全球大类资产量化综合评分与运行状态排行榜】:
     - 黄金(518880/517520)、原油(160416)、美股科技(513100/159509)、红利银行(601288/600036)、创业板(159915)、科创50(588000)
  2. 【🎯 旗下核心策略当前实盘持仓速览 (精准校对)】:
     - 科创-银行 DTB-Apex V2.0：50% 黄金股ETF (517520) + 50% 农业银行 (601288) [弱势防守避险]
     - 纳指-双核银行策略：50% 纳指100 (513100) + 11.9% 农行 + 18.1% 招行 + 20% 黄金 [平稳收息]
     - 五福 5.2/7.3 日内趋势：100% 货币基金 / 场内现金防守 [破MA10防守]
     - ⭐ 七星跨板块 ETF 轮动：100% 华安黄金ETF (518880) [领跑龙头/原油溢价熔断保护]
     - 场外公募基金轮动：006503 财通集成电路芯片混合 [半导体高景气/周四免申赎]
...
def run_macro_evening_pipeline(webhook_url: str = MACRO_EVENING_WEBHOOK):
    print("=" * 100)
    print("🏛️【全球宏观大势与量化全景战略研报】策略实盘持仓精准校对版启动...")
    print("=" * 100)

    # 1. 采集数据与排行榜计算
    print(">>> [1/4] 正在拉取全球核心大类资产多源行情并计算量化评分与精准持仓...")
